...
const { setLoading, loading } = useContext(StoreContext);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch(`${url}/api/car/car-by-date?start=${startDate}&end=${endDate}&state=${state}`);
    ...
    return (
        <div className='list add flex-col'>
            ...
            <div ref={printRef}>
                <div>
                    <h2 className="text-center mb-2"> Liste aller Autos</h2>
                    <div className="list-table">
                        ...
                        cars.map((car, index) => (
                            <div key={car._id || index} className="list-table-formats">
                                <p>{index + 1}</p>
                                <p><img src={`${url}/images/${car.image}`} alt={car.name} /></p>
                        ...
                        <div className="list-table-formats total-row">
                            <p colSpan="4"><strong>die Gesamtsumme </strong></p>
                            <p></p>
                            <p></p>
                            <p></p><p><strong>{allPrice} €</strong></p><p></p>
                        </div>
                    </div>
                </div>
            </div>
